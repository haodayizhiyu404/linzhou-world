...
//  构建时间：2026-09-22T15:37:05.844Z
// ═══════════════════════════════════════════════════════════
var __LZW_BUILD__ = '2026-09-22 15:37';
  ...
  momentsReact: function (post, people, snapshot, userInfo, recentPriv, recentGrp) {
    ...
    memo: function (contact, hist, snapshot, userInfo, usedDates, shortRetry) {
      ...
      var reqs = [
        ...
        '- 用具体的生活细节落地——写什么物件取决于这个人是谁（工具、账本、药盒、车库、课桌都算）。抒情不是禁区，恰恰是备忘录的本分：Ta 可以在这里承认想念、动摇、喜欢、怨——允许迟疑、改口、一句话说到一半停下（"我不知道这算不算爱，但是……"）。要禁止的只是空泛无对象的感叹句（"生活如此艰难"这类）。',
...
(function () {
  ...
  var ENGINE_VER = '2026-09-22c';      // 发版即改，boot 日志打出，远程对版本用
